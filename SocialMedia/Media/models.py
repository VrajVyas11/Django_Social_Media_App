...
class User(AbstractUser):
    ...
    groups = models.ManyToManyField(
        'auth.Group',
        related_name='media_user_set',  # Custom related_name for the reverse accessor
        blank=True
    )
    user_permissions = models.ManyToManyField(
        'auth.Permission',
        related_name='media_user_permissions',  # Custom related_name for the reverse accessor
        blank=True
    )
