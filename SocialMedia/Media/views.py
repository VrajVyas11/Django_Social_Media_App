...
def login_view(request):
    if request.method == "POST":
        ...
        return render(request, "Media/login.html",{'form': LoginForm})
...
def register(request):
    if request.method == "POST":
        ...
        return render(request, "Media/register.html",{'form': RegistrationForm})
...
def get_all_users(request):
    ...
    return render(request, 'Media/display.html', {'users': users})
